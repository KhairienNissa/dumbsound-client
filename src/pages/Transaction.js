        ...
        {userTrans?.status === "success" ? 
            ...
            <div className="transaction-container d-flex flex-1 flex-column">
              ...
              <div className='d-flex flex-1 align-items-center text-center justify-content-center flex-column text-white mx-2'>
                ...
                <button type="submit" className="bg-orange px-5 py-3 text-white fw-500 py-2 borra-3" onClick={() => handleBuy("30000")}>Bayar Sekarang</button>
              </div>
            </div> :
            ...
            <div className="transaction-container d-flex flex-1 flex-column">
                ...
                <div className='d-flex flex-1 align-items-center text-center justify-content-center flex-column text-white mx-2'>
                  ...
                  <button type="submit" className="btn btn-outline-light text-orange px-5 py-2 fw-500 py-2 borra-3" onClick={() => handleBuy("30000")}>Try payment</button>
                </div>
            </div>
        }
        </>
